...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Se todos os \(\Delta_{ij} \ge 0\), pare, a solução é ótima;
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Alterne entre células básicas e não básicas, formando um caminho fechado;
    ...
    \item \textbf{Repetir o processo} até que todos os \(\Delta_{ij} \ge 0\).
\end{enumerate}
\end{frame}
...
\begin{itemize}
    ...
    \item Pode ser facilmente implementado em planilhas eletrônicas ou softwares de otimização.
\end{itemize}
\end{frame}
